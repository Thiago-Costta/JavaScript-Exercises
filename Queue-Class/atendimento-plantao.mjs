...
let filaHospital = new Queue()

filaHospital.enqueue("José")
filaHospital.enqueue("Sérgio")
filaHospital.enqueue("Joaquim")
filaHospital.enqueue("Maria")
filaHospital.enqueue("João")
filaHospital.enqueue("Samuel")
filaHospital.enqueue("Vicente")
filaHospital.enqueue("Terezinha")
filaHospital.enqueue("Firmino")
filaHospital.enqueue("Toninho")
filaHospital.enqueue("Alexandre")

console.log(filaHospital.print())
filaHospital.dequeue(console.log(filaHospital.peek()))
console.log(filaHospital.print())
filaHospital.enqueue("Rafael")
filaHospital.enqueue("Isabela")
filaHospital.enqueue("Cauã")
console.log(filaHospital.print())
filaHospital.dequeue(console.log(filaHospital.peek()))
console.log(filaHospital.print())